          ...
          <ol className="space-y-3 text-sm">
            {roomMap.steps.map((step, index) => (
              <li key={step} className="flex gap-3">
                <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-teal-100 text-xs font-semibold text-teal-800 dark:bg-muted dark:text-foreground">
                  {index + 1}
                </span>
                <span>{step}</span>
              </li>
