...
export function GuestShell({
  ...
  return (
    <div className="min-h-dvh bg-background bg-[radial-gradient(circle_at_top,_rgba(15,118,110,0.08),_transparent_45%)] dark:bg-[radial-gradient(circle_at_top,_rgba(120,120,120,0.06),_transparent_55%)]">
